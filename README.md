# WARNING : This is a fork of the linuxserver/wireguard image to use iptables instead of nftables.
# This is because nftables is not supported by the kernel in the arm64v8 image.
# This is a temporary solution to get the wireguard container working on the arm64v8 image.
# This repository is not maintained by the linuxserver.io team or by me.
